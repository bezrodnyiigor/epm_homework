...
import com.epm.recipe.persistence.db.JdbcPersistenceConfiguration;
...
public class Bootstrap {
    ...
    public static void main(String[] args) throws Exception {
        ...
        context.register(JdbcPersistenceConfiguration.class, ServicesConfiguration.class, WebUiConfiguration.class);
